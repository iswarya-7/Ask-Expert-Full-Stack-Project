    ...
    if (request.getParameter("change_password") != null) {
        ...
        if (pass == null || pass.trim().isEmpty()) {
            ...
            try {
                ...
                PreparedStatement checkPs = con.prepareStatement("SELECT password FROM user_registerdetails WHERE email = ?");
                ...
                if (rs.next()) {
                    ...
                    if (pass.equals(currentPass)) {
                        ...
                        if (updated > 0) {
                            ...
                            response.sendRedirect("user_home.jsp?message=sucess");
                            return;
                        } else {
                            message = "Password change failed. Please try again.";
                            response.sendRedirect("user_home.jsp?message=error");
