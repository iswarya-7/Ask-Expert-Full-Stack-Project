...
<%
    ...
    String sname = "";
    out.print("<script>console.log('User ID: " + uId + "')</script>");
    if (uId != null) {
        try {
            Class.forName("com.mysql.jdbc.Driver");
            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/askexpert", "root", "");
            PreparedStatement ps = conn.prepareStatement("SELECT * FROM questions WHERE user_id = ? AND status='pending'");
            ps.setInt(1, uId);
    ...
    <head>
        ...
        <style>
            ...
            * {
            ...
            /*for question edit and delete option*/
    ...
    <body>
        <div class="app-container">
            ...
            <div class="main-wrapper">
                ...
                <!-- Main Content -->
                <main class="main-content" id="main-content" style="margin-left:270px; margin-top: 40px;">
                    <!-- Content will be loaded here -->

                    <!--<div class="content-wrapper">-->
                    <h1>My Questions</h1>
                    <!--getting userid using hidden input field-->
                    <input type="hidden" value="<%=uId%>" name="userid" id="userid"/>
                    <div class="question-filters">
                        <a href="<%= request.getContextPath()%>/user_interface/UserGetAllQuestion.jsp">    <button class="filter-btn " data-filter="all">All Questions</button></a>
                        <a href="<%= request.getContextPath()%>/user_interface/UserGetPendingQuestion.jsp">  <button class="filter-btn " data-filter="Pending">Pending</button></a>
                    </div>
                    ...
                    <div class="question-list" >
                        <div class="question-card" data-status="<%= status%>">
                            ...
                            <div class="question-footer">
                                ...
                                <!--to display the edit and delete option-->
                                <div class="actions">
                        ...
                        <div id="editModal" class="modal">
                            <div class="modal-content">
                                ...
                                <form id="editQuestionForm" action="<%= request.getContextPath()%>/user_interface/EditUserQuestion.jsp" method="post">
                        ...
                        <div id="deleteModal" class="modal">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <form id="deleteQuestionForm" action="<%= request.getContextPath()%>/user_interface/DeleteUserQuestion.jsp" method="post">
                        ...
                        <%
                            ...
                            if (!hasAnswered) {
                        %>
                        <p style="margin-left: 7px;color: red;">No Pending questions available.</p>
