...
<%    String message = "";
    ...
    String uname = "", category = "", question = "", status = "", formattedDate = "";
                ...
                <main class="main-content">
                    <div class="content-wrapper">
                        ...
                        <div class="question-list">
                            <%
                                boolean hasResults = rs.next(); // Try moving to the first row

                                if (!hasResults) {
                            %>
                            <div style="text-align: left; padding: 0px 20px 10px 3px; font-size: 16px; color: #666;">
        ...
        <div id="answer-overlay" class="answer-overlay">
            <div class="answer-form-container">
                <div class="answer-form-header">
                    ...
                    <img id="user-avatar" class="user-avatar" src="<%= request.getContextPath()%>/profileimages/<%= session.getAttribute("profileimage")%>" alt="User Profile"> 
                ...
                <form action="${pageContext.request.contextPath}/AnswerQuestionServlet" method="post">
                    ...
                    <input type="hidden" name="questionid" value="<%=questionId1%>" />
                    ...
                    <div class="answer-form-body">
                        ...
                        <div class="answer-form-footer">
                            <button id="submit-answer-button" class="submit-answer-button" onclick="submitAnswer()">Submit Answer</button>
                        </div>
                    </div>
                </form>
            ...
            <script>
                // Store user profiles in JavaScript
                //            const userProfiles = {
                ...
                <%--    img.src = "<%= request.getContextPath()%>/profileimages/default-avatar.png"; --%>
                ...
                <%--          const profilePath = userProfile ? '<%= request.getContextPath()%>/profileimages/' + userProfile : '<%= request.getContextPath()%>/profileimages/default-avatar.png'; --%>
                    //            document.getElementById('user-avatar').src = profilePath;
                ...
                function submitAnswer() {
                    const questionId = document.getElementById('answer-overlay').getAttribute('data-question-id');
                    ...
                    // Here you would typically send the answer to the server via AJAX
                    // For now, we'll just redirect to a hypothetical answer submission page
                    window.location.href = 'submit_answer.jsp?questionId=' + questionId + '&answer=' + encodeURIComponent(answerText);
                    // Or you could implement an AJAX call to submit the answer
                    /*
                     fetch('submit_answer.jsp', {
                     method: 'POST',
                     headers: {
                     'Content-Type': 'application/x-www-form-urlencoded',
                     },
                     body: 'questionId=' + questionId + '&answer=' + encodeURIComponent(answerText)
                     })
