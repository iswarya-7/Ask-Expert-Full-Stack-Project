...
//    }
    ...
    try {
        ...
        PreparedStatement ps = con.prepareStatement("SELECT id, token_expiry FROM specialist_regdetails WHERE reset_token=?");
...
<html>
    <head>
        <title>Specialist - Reset Password</title>
    ...
    <body>
        ...
        <div class="modal-content" id="passwordModal">
            <form method="post"  action="${pageContext.request.contextPath}/SpecialistUpdatePasswordServlet">
                <div class="form_data">
                    <!-- Close Icon -->
