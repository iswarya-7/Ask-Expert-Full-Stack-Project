...
<html lang="en">
    ...
    <head>
        ...
        <title>Specialist Forgot Password</title>
        <!-- external css link -->
    ...
    <body>
        <form method="post" action="${pageContext.request.contextPath}/SpecialistPassResetLinkServlet" class="form" onsubmit="return forgot()">
            <div class="form_data">
