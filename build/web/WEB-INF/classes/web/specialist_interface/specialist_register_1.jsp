...
<html>
    ...
    <body style="background:#F8F9FA;">
        ...
        <!-- form -->
        <div class="register">
            <form method="post" action="<%=request.getContextPath()%>/SpecialistRegister_Details" onsubmit="return registers(event)"  enctype="multipart/form-data">
                <div class="form_data">
                    ...
                    <div class="input">
                        ...
                        <input type="text" name="linkedin" placeholder="LinkedIn Profile or other professional social media"
                               id="linkedin">
                    </div>
...
//                    window.location.href = "<%=request.getContextPath()%>/specialist_interface/specialist.jsp" //redirect the login page
                    return true;
                }
