...
<html lang="en">
    <head>
        ...
        <title>Ask Expert - Add Question</title>
                ...
                <main class="main-content" id="main-content">
                    ...
                    <div class="main-content1">
                        <div class="question-form-container">
                            ...
                            <form action="${pageContext.request.contextPath}/QuestionStoreServlet" method="post" class="question-form"  >


                                <!--get the user name and id in hidden input field using session id-->
                                <input type="hidden" id="uname" name="uname" value="<%= fname%>"  >
                                <input type="hidden" id="uid" name="uid" value="<%= id%>"  required>
                                ...
                                <div class="form-actions">
                                    <button type="button" class="btn btn-secondary" onclick="window.location.href = 'user_home.jsp'">Cancel</button>
