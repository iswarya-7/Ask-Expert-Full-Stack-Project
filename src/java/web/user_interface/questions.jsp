...
//    Make sure the page loads with "all" filter by default
    if (session.getAttribute("filter") == null) {
        session.setAttribute("filter", "all");
    }

    out.print("<script>console.log('User ID: " + userId + "')</script>");
    String uid = "";
    if (userId != null) {
        try {
...
//            uid = String.valueOf(userId);
    ...
    uid = (userId != null) ? String.valueOf(userId) : "";
                ...
                <main class="main-content" id="main-content" style="margin-left:70px; margin-top: 40px;" >
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="question-filters">
                            <a href="${pageContext.request.contextPath}/GetQuestionServlet?filter=all&userId=<%= userId%>">    <button class="filter-btn <%= ("all".equals(filter) || filter == null) ? "active" : ""%>" data-filter="all">All Questions</button></a>
                            <a href="${pageContext.request.contextPath}/GetQuestionServlet?filter=Pending&userId=<%= userId%>">  <button class="filter-btn <%= "Pending".equals(filter) ? "active" : ""%>" data-filter="Pending">Pending</button></a>
                            <a href="${pageContext.request.contextPath}/GetQuestionServlet?filter=Answered&userId=<%= userId%>">     <button class="filter-btn <%= "Answered".equals(filter) ? "active" : ""%>" data-filter="answered">Answered</button></a>
                        </div>
