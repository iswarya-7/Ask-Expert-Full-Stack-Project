...
<%
    ...
    try {
        ...
        String query = "SELECT a.answer_id, a.answer_text, a.answered_time ,q.category,q.specialist_id,q.specialist_name,q.user_id,q.question, q.user_name, q.posted_at "
                + "FROM answers a "
                + "JOIN questions q ON a.question_id = q.question_id "
                + "WHERE q.user_id = ? AND status ='Answered' ORDER BY q.question_id DESC";
        ...
        <style>
            ...
            * {
            ...
            .maincontent {
                ...
                width: calc(100% - 280px); /* Dynamically calculate width */
                margin-top: 20px;
            }
    ...
    <body>
        ...
        <div class="app-container ">
            ...
            <div class="main-wrapper">
                ...
                <!-- Main Content -->
                <main class="main-content" id="main-content" style="margin-top: 40px;" >
                    <!-- Content will be loaded here -->
                    <h2 style="margin-left:270px; margin-top: 10px;  font-size:26px; font-weight: 700;">Explore Answers from Experts</h2>
                        ...
                        <div class="feed" id="question-feed">
                            <%                        boolean isanswer = false;
                                while (rs.next()) {
                                    ...
                                    Integer spid = rs.getInt("specialist_id");
                            ...
                            <%
                                ...
                                if (!isanswer) {
                            %>
                            <p style="color:red;margin-left:150px;margin-top: 10px;">No Answer found !</p>
                            <%
                                }%>
                        </div>
                    </div>
