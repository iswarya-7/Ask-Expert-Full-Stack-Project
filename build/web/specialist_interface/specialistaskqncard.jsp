...
<%
    Integer userId = (Integer) session.getAttribute("specialistId");
    ...
    if (userId != null) {
        try {
            ...
            ps = conn.prepareStatement("SELECT * FROM specialist_regdetails WHERE id = ?");
            ps.setInt(1, userId);
            rs = ps.executeQuery();
                    ...
                    <div class="maincontent">
                        <div class="main-container">
                            <div class="question-card">
                                ...
                                <form action="${pageContext.request.contextPath}/SpecialistQuestionServlet"   onsubmit="return validateQuestionForm()" method="post">

                                    <input type="hidden" id="uname" name="sname" value="<%= fname%>"  required>
                                    <input type="hidden" id="uid" name="sid" value="<%= uid%>"  required>
                                    ...
                                    <textarea name="question"  id="question" placeholder="Type your question here..." ></textarea>
