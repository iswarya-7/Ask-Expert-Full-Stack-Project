...
//    Integer sId = (Integer) session.getAttribute("specialistId");
    ...
    String fname = "", gender = "", mobile = "", email = "", profilePhoto = "", category = "", expertise_domain = "", years = "", bio = "", portfolio = "", workplace = "",id="";

    if (session2 != null) {
        try {
            Class.forName("com.mysql.jdbc.Driver");
            int specialistId = (int) session2.getAttribute("id");
            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/askexpert", "root", "");
            PreparedStatement ps = conn.prepareStatement("SELECT * FROM specialist_registerdetails WHERE id = ?");
            ...
            if (rs.next()) {
                ...
                id = rs.getString("id");
                out.println("Specialist ID: " + specialistId);
            ...
            <main class="main-content" id="main-content">
                ...
                <div class="container" id="cl">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            <label for="years">Experience Years</label>
                            <input type="text" id="years"   value="<%= years%>" name="experience"  >
                        </div>
                        <div class="form-group">
                            <label for="years">Workplace</label>
                            <input type="text" id="workplace"   value= "<%= workplace%>" name="workplace"  >
                        </div>

                        <div class="form-group">
                            <label for="portfolio">Portfolio</label>
                            <input type="url" id="portfolio"   value="<%= portfolio%>" name="portfolio" >
                        </div>
...
//            user form validation
        function saveForm() {
            ...
            const data = {
                ...
                experience: document.getElementById('years').value.trim(),
            ...
            if (!data.name || !data.phone || !data.category || !data.experience || !data.workplace || !data.portfolio || !data.bio) {
