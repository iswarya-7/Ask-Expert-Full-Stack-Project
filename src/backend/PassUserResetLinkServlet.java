...
@WebServlet("/PassUserResetLinkServlet")
public class PassUserResetLinkServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement("SELECT * FROM user_registerdetails WHERE email=?");
            ...
            if (rs.next()) {
                ...
                if ("yes".equalsIgnoreCase(blocked)) {
                    ...
                    PreparedStatement update = con.prepareStatement("UPDATE user_registerdetails SET reset_token=?, token_expiry=? WHERE email=?");
                    ...
                    // Send email
                    String link = "http://localhost:8084/FinalAskexpert/user_interface/UserReset_password.jsp?token=" + token;
...
//        msg.setContent("Click the link to reset your password: <a href='" + link + "'>Reset Password</a>", "text/html");
