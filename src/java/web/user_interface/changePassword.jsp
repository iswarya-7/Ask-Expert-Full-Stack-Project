...
//        out.print("Pass :" + pass);
        if (pass == null || pass.trim().isEmpty()) {
            ...
            try {
                ...
                PreparedStatement ps = con.prepareStatement("UPDATE user_registerdetails SET password = ?,cpassword=? WHERE email = ?");
                ps.setString(1, pass);
                ...
                if (updated > 0) {
                    ...
                    out.print("<script>alert('Password changed successfully!'); window.location.href='user_home.jsp?message=sucess';</script>");
//                    response.sendRedirect("user_home.jsp?message=" + message);
                    return;
                } else {
                    message = "Password change failed. Please try again.";
                    out.print("<script>alert('Password changed successfully!'); window.location.href='user_home.jsp?message=error';</script>");
//                    response.sendRedirect("user_home.jsp?message=" + message);
                }
            } catch (Exception e) {
                e.printStackTrace();
