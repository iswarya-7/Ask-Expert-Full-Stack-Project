...
<%
    ...
    try {
        ...
        String query = "SELECT a.answer_id, a.answer_text, a.answered_time, q.category,q.specialist_name,q.question, q.user_name, q.posted_at "
                + "FROM answers a "
                + "JOIN questions q ON a.question_id = q.question_id "
                + "WHERE q.specialist_id = ? ORDER BY q.question_id DESC";
